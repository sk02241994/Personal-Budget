...
public class BudgetActivity extends AppCompatActivity {
        ...
        budgetRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists() && snapshot.getChildrenCount() > 0) {
                    ...
                    String sTotal = String.valueOf("Monthly budget: Rs." + totalAmount);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if("Select item".equals(budgetItem)){
                    ...
                    Data data = new Data(budgetItem, date, id, itemNDay, itemNWeek, itemNMonth, null, Integer.parseInt(budgetAmount), months.getMonths(), weeks.getWeeks());
    ...
    private void updateData() {
        ...
        updateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Data data = new Data(item, date, postKey, itemNDay, itemNWeek, itemNMonth, null, amount, months.getMonths(), weeks.getWeeks());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setDate(String itemDate){
            TextView amount = mView.findViewById(R.id.date);
            amount.setText(itemDate);
        }
    }
